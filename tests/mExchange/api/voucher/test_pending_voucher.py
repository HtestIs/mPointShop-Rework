import pytest
from api.mExchange.flows.voucher_flow import (
    find_and_commit_voucher_pool_in_mexchange,
    find_voucher_pool_in_mexchange,
)
from api.mPointShop.flows.voucher_flow import create_and_sync_voucher_to_mexchange
...
@pytest.mark.ongoing
def test_sync_voucher_to_partner(logged_in_client_partner,create_voucher_discount_percentage,mexchange_client_ui):
    reponse = create_voucher_discount_percentage
    result = create_and_sync_voucher_to_mexchange(logged_in_client_partner, reponse)
    commit_result = find_and_commit_voucher_pool_in_mexchange(mexchange_client_ui, result["voucher_id"])
