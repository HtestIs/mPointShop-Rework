...
from mPointShop.api.api_assertions.store_assertions import assert_code_response, assert_valid_post_response, assert_validation_error_type, assert_store_page_response, assert_store_response

pytestmark = [
    pytest.mark.mpointshop,
    allure.parent_suite("mPointShop"),
    allure.suite("API"),
    allure.sub_suite("Stores"),
]
